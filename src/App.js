        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
                <Bookshelf bookDataArr={bookDataCurrently} title={"Currently Reading"}/>
                <Bookshelf bookDataArr={bookDataWantToRead} title={"Want to Read"}/>
                <Bookshelf bookDataArr={bookDataRead} title={"Read"}/>
            </div>
